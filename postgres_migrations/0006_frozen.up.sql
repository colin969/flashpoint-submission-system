ALTER TABLE game ADD COLUMN archive_state integer DEFAULT 2;
ALTER TABLE changelog_game ADD COLUMN archive_state integer DEFAULT 2;
...
INSERT INTO changelog_game (id, parent_game_id, title, alternate_titles, series, developer,
                            ...
                            user_id, platform_name, archive_state)
VALUES (NEW.id, NEW.parent_game_id, NEW.title, NEW.alternate_titles, NEW.series, NEW.developer,
        ...
        NEW.user_id, NEW.platform_name, NEW.archive_state);
